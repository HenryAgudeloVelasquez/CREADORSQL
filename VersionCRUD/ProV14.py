...
def crear_crud_sql():
    ...
    def guardar_archivos():
        ...
        try:
            ...
            crear_archivo_cs(ubicacion, nombre_general, columnas)  # Crear archivo .cs
    ...
    columnas_tipos = []
    botones_eliminar = []
    tipos_datos = ["INT", "VARCHAR(255)", "TEXT", "DATE", "FLOAT", "DECIMAL", "BOOL", "DATETIME"]  # Tipos de datos ampliados
...
def convertir_tipo_dato(tipo_sql):
    ...
    if tipo_sql in ("INT", "INTEGER"):
        ...
        return "object"  # Tipo de dato por defecto si no se encuentra coincidencia
