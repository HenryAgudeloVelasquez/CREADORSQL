...
def crear_crud_sql():
    ...
    def guardar_archivos():
        ...
        try:
            ...
            crear_procedimientos_almacenados(ubicacion, nombre_tabla, columnas, fecha_actual, procedimientos, alias)
    ...
    def agregar_columna():
        ...
        eliminar_button = tk.Button(columnas_frame, text="Eliminar", command=lambda: eliminar_columna(fila))
...
def crear_procedimientos_almacenados(ubicacion,
                                    ...
                                    nombre_getlist,
                                    nombre_getlistall,
                                    alias=""):  # Se agrega el parámetro alias
    """Crea los archivos SQL para el CRUD con nombres personalizados."""

    # --- ADD ---
    nombre_proc_add = f"{alias}{nombre_add or 'Insertar'}"  # Se concatena el alias
    contenido_add = f"""
-- =============================================
