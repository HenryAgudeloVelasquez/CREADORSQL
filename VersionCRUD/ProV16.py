...
def cargar_archivo_clientes():
    """Carga el archivo CSV de clientes."""
    global clientes  # Usaremos un dataframe global para almacenar los clientes
...
def cargar_archivo_productos():
    """Carga el archivo CSV de productos."""
    global productos  # Usaremos un dataframe global para almacenar los productos
    filepath = filedialog.askopenfilename(
        initialdir="/",
